...
export const COMPANY_DATA: CompanyData[] = [
  ...
  },
  {
    ...
    opcoes: [
      ...
      "Controle concentrado (um ou mais grupos que concentram a maior parte do direito de controle)",
...
export const QUESTIONS: Question[] = [
  ...
  {
    numero: "46",
    dimensao: "Empresas de controle concentrado",
    indicador: null,
    texto: "Existem regras claras para a contratação de proprietários e relacionados na empresa?",
    tipo: "multipla_escolha_unica",
    opcoes: ["não", "sim"],
    referencia: "Caderno 15: 6.2, 6.5 / Protocolo de governança na longevidade da empresa: 2.3"
  },
  {
    numero: "47",
    dimensao: "Empresas de controle concentrado",
    indicador: null,
    texto: "Os proprietários possuem conselho de proprietários ou outro fórum de governança?",
    tipo: "multipla_escolha_unica",
    opcoes: [
      "não",
  ...
  },
  {
    ...
    dimensao: "Empresas de controle concentrado",
    indicador: null,
    texto: "Os proprietários possuem protocolo de governança ou constituição societária?",
    tipo: "multipla_escolha_unica",
    opcoes: ["não", "sim"],
    referencia: "Caderno 15: 5.2, 6.5 / Caderno 12: 4.13 / O papel do protocolo de governança na longevidade da empresa: 1"
  },
  {
    numero: "49",
    dimensao: "Empresas de controle concentrado",
    ...
    opcoes: [
      "não",
      "sim, acordo de sócios e/ou protocolo de governança",
      "sim, outro documento"
    ],
    referencia: "Caderno 15: 5.2, 6.5 / Caderno 12: 4.9 / O papel do protocolo de governança na longevidade da empresa: 1"
  },
  {
    numero: "50",
    dimensao: "Empresas de controle concentrado",
    indicador: null,
    texto: "Os proprietários possuem comitê de sócios ou outro fórum com a função de direcionar a participação dos sócios nas assembleias/reuniões?",
    tipo: "multipla_escolha_unica",
    opcoes: [
      "não",
    ...
    referencia: "Caderno 15: 5.4 / O papel do protocolo de governança na longevidade da empresa: 2.2"
  },
  {
    numero: "51",
    dimensao: "Empresas de controle concentrado",
    indicador: null,
    texto: "Há plano de sucessão para os proprietários que ocupam cargos-chave na gestão?",
    tipo: "multipla_escolha_unica",
    opcoes: [
      "não",
      "sim, para todos",
    ...
    referencia: "Caderno 15: 4.8 / Sucessão em empresas de controle concentrado: 4"
  }
];
