...
import { LayoutDashboard, Settings, Building, DollarSign, Rocket, Building2, Globe, TrendingUp, Crown, Sparkles, Leaf, Check, Lock } from "lucide-react";
        ...
        <SidebarContent>
          {isAdminRoute ? (
            ...
            SIDEBAR_SECTIONS.map((section) => {
              // Check if section has any items (enabled or locked)
