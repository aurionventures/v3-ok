    ...
    <header className="sticky top-0 z-50 bg-[#0A1628]/95 backdrop-blur-md border-b border-white/10">
      <div className="container mx-auto flex justify-between items-center px-6 py-4 relative">
        ...
        <div className="flex items-center gap-3">
          <Button
            className="bg-legacy-gold text-legacy-500 hover:bg-legacy-gold hover:text-legacy-500 active:bg-legacy-gold active:text-legacy-500 focus:bg-legacy-gold focus:text-legacy-500 focus-visible:ring-legacy-gold/50 font-montserrat font-semibold text-sm px-5 py-2"
