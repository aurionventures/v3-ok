...
const documentTemplates = [
  {
    id: 1,
    name: "Protocolo de Governança",
    description: "Documento que estabelece as regras e diretrizes para a participação dos proprietários no negócio",
    content: `PROTOCOLO DE GOVERNANÇA DOS PROPRIETÁRIOS SILVA

1. PROPÓSITO
Este protocolo tem como objetivo estabelecer diretrizes claras para a participação dos proprietários nos negócios, preservando a harmonia entre stakeholders e a continuidade empresarial.
...
3. GOVERNANÇA DE PROPRIETÁRIOS
3.1 Assembleia de Proprietários: Reunião anual obrigatória para todos os sócios
3.2 Conselho de Proprietários: Órgão deliberativo composto por representantes dos acionistas
3.3 Escritório de Investimentos: Estrutura profissional para gestão patrimonial

4. CRITÉRIOS PARA PARTICIPAÇÃO NO NEGÓCIO
- Formação superior completa
- Experiência profissional externa mínima de 5 anos
- Aprovação do Conselho de Proprietários
- Demonstração de alinhamento com os valores corporativos
...
Todo conflito será inicialmente tratado no âmbito dos proprietários. Em caso de impasse, será acionada mediação externa especializada.`
  },
  {
    id: 2,
...
const familyRituals = [
  {
    id: 1,
    name: "Assembleia de Proprietários Anual",
  ...
  {
    id: 3,
    name: "Celebração do Legado Empresarial",
    description: "Celebração da história e contribuições da empresa para a sociedade.",
    frequency: "Anual",
    lastDate: "20/08/2024",
    nextDate: "20/08/2025",
  },
  {
    ...
    description: "Revisão do alinhamento entre propósitos individuais e o propósito corporativo.",
    frequency: "Semestral",
    lastDate: "05/02/2025",
    nextDate: "05/08/2025",
  },
            ...
            <CardContent className="pt-6 px-6">
              ...
              <Tabs defaultValue="manifesto" onValueChange={setSelectedTab}>
                <TabsList className="mb-4">
                  ...
                  <TabsTrigger value="rituais">Rituais Corporativos</TabsTrigger>
                  ...
                  <div className="flex justify-end mb-4">
                    <Dialog>
                      ...
                      <DialogContent className="sm:max-w-[500px]">
                        <DialogHeader>
                          <DialogTitle>Adicionar Ritual Corporativo</DialogTitle>
                          <DialogDescription>
                            Cadastre um novo ritual para a organização
                          </DialogDescription>
                        </DialogHeader>
