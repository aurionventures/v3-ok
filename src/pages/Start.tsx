  ...
  const quickActions = [
    {
      ...
      description: "Configure sua conta e comece a jornada",
    ...
    },
    {
      ...
      description: "Identifique documentos existentes",
    ...
    },
    {
      ...
      description: "Meça o nível atual de governança",
    ...
    },
    {
      ...
      description: "Centralize documentos importantes",
      icon: <FileText className="h-6 w-6" />,
