...
export default function InitialReport() {
  ...
  const generateReport = async () => {
    ...
    const interviewStats = {
      ...
      avgAlignment: interviews.length > 0 
        ? Math.round(interviews.reduce((sum: number, int: any) => sum + int.alignmentScore, 0) / interviews.length)
        : 0,
  ...
  const getSeverityBadge = (severity: string) => {
    switch (severity) {
      ...
      case 'low': return <Badge className="bg-green-500">Baixa</Badge>;
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              {reportData.incongruences.length === 0 ? (
                ...
                <div className="space-y-4">
                  {reportData.incongruences.map((incongruence, index) => (
                  ...
                  {reportData.gaps.map((gap, index) => (
                    <div key={index} className="border rounded-lg p-4">
                      ...
                      <div className="space-y-1">
                        {gap.missing.map((item, itemIndex) => (
        ...
        {reportData.interviewStats.keyTopics.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {reportData.interviewStats.keyTopics.map((topic, index) => (
