...
const SubmitProjects = () => {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      "Aguardando Análise": { color: "bg-yellow-100 text-yellow-800", icon: Clock },
      "Analisado por IA": { color: "bg-blue-100 text-blue-800", icon: Bot },
      "Enriquecido pela IA": { color: "bg-purple-100 text-purple-800", icon: Sparkles },
      "Submetido para Votação": { color: "bg-orange-100 text-orange-800", icon: Vote },
      "Aprovado": { color: "bg-green-100 text-green-800", icon: CheckCircle2 },
      "Rejeitado": { color: "bg-red-100 text-red-800", icon: AlertTriangle },
    };
                          ...
                          <TableRow key={project.id}>
                            ...
                            <TableCell>
                              {project.aiAnalysis ? (
                                ...
                                <span className="text-sm text-gray-500">Não analisado</span>
                              )}
                            </TableCell>
                            <TableCell>
                      ...
                      <TableBody>
                        {filteredVotedProjects.map((project) => (
                          <TableRow key={project.id}>
                            ...
                            <TableCell>
                              <Badge 
                                className={project.status === "Aprovado" 
                            ...
                            <TableCell>
                              <div className="text-sm">
                                <div className="flex items-center gap-4">
                                  ...
                                  {project.votes.abstencoes > 0 && (
                                    <span className="text-gray-600">⊘ {project.votes.abstencoes}</span>
                                  )}
                                </div>
                              </div>
                            </TableCell>
            ...
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
              ...
              {selectedProject && (
                <div className="space-y-6">
                  ...
                  {selectedProject.aiAnalysis?.recommendations && (
                    <div>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <div className="flex items-center gap-6 mb-2">
                          ...
                          {selectedProject.votes.abstencoes > 0 && (
