...
const initialModules: ModuleProgress[] = [
  // PREPARAÇÃO
  {
    ...
    description: 'Configuração inicial e orientações da plataforma',
    ...
    completionCriteria: [
      'Conclusão do tour da plataforma',
      'Configuração do perfil da empresa',
      'Definição de objetivos principais'
    ],
    nextActions: [
      'Completar configuração do perfil',
      'Definir objetivos de governança'
    ]
  },
  {
    id: 'document-checklist',
    name: 'Checklist de Documentos',
    description: 'Identificação de documentos existentes',
    ...
    completionCriteria: [
      'Marcação de pelo menos 15 documentos',
      'Classificação por categoria',
      'Status de completude atualizado'
    ],
    nextActions: [
      'Revisar documentos societários',
      'Marcar documentos existentes'
    ]
  },
  {
    id: 'document-upload',
    name: 'Upload de Documentos',
    description: 'Repositório de documentos organizacionais',
    ...
    completionCriteria: [
      'Upload de pelo menos 5 documentos',
      'Categorização automática',
      'Análise de IA concluída'
    ],
    nextActions: [
      'Fazer upload do estatuto social',
      'Adicionar protocolo familiar'
    ]
  },
  {
    id: 'interviews',
    name: 'Entrevistas',
    description: 'Coleta e análise de entrevistas familiares',
    ...
    completionCriteria: [
      'Pelo menos 3 entrevistas coletadas',
      'Transcrição automática realizada',
      'Análise de alinhamento concluída'
    ],
    nextActions: [
      'Agendar entrevista com fundador',
      'Coletar entrevista dos herdeiros'
    ]
  },
  {
    id: 'initial-report',
    name: 'Relatório Inicial',
    description: 'Diagnóstico inicial de governança',
    ...
    completionCriteria: [
      'Análise de incongruências concluída',
      'Gaps de documentação identificados',
      'Plano de ação gerado pela IA'
    ],
    nextActions: [
      'Aguardar conclusão do checklist',
      'Completar análise de documentos'
    ]
  },
  // FUNDAÇÃO
  {
  ...
  },
  {
    ...
    description: 'Submissão e aprovação de projetos familiares',
    ...
    estimatedValue: 180000,
    completionCriteria: [
      'Cadastro de pelo menos 2 projetos',
  ...
  },
  {
    id: 'legacy',
    name: 'Legado',
    description: 'Preservação e transmissão do legado familiar',
    completionPercentage: 30,
    isCompleted: false,
    weight: 10,
    icon: 'Landmark',
    ...
    estimatedValue: 200000,
    completionCriteria: [
      'Definição dos valores familiares',
      'Documentação da história familiar',
      'Plano de transmissão de legado'
    ],
    nextActions: [
      'Documentar valores centrais',
      'Criar história familiar'
    ]
  },
  ...
  },
  {
    id: 'activities',
    name: 'Atividades',
    description: 'Monitoramento de atividades e métricas',
    completionPercentage: 45,
    isCompleted: false,
    weight: 6,
    icon: 'Activity',
    ...
    estimatedValue: 150000,
    completionCriteria: [
      'Configuração de pelo menos 5 atividades',
