...
const INITIAL_ADDONS: AddonCatalog[] = [
  { id: "1", key: "submeter_projetos", name: "Submeter Projetos", description: "Submeta projetos para deliberação", icon: "FolderUp", monthly_price: 497, annual_price: 4970, category: "governance", target_section: "estruturacao", target_section_label: "ESTRUTURAÇÃO", order_index: 1, is_active: true, is_visible: true },
  { id: "2", key: "desenvolvimento_pdi", name: "Desenvolvimento e PDI", description: "Planos de desenvolvimento individual", icon: "GraduationCap", monthly_price: 697, annual_price: 6970, category: "people", target_section: "gestao_pessoas", target_section_label: "GESTÃO DE PESSOAS", order_index: 2, is_active: true, is_visible: true },
  { id: "3", key: "desempenho_conselho", name: "Desempenho do Conselho", description: "Avaliação 360° dos membros", icon: "Target", monthly_price: 597, annual_price: 5970, category: "people", target_section: "gestao_pessoas", target_section_label: "GESTÃO DE PESSOAS", order_index: 3, is_active: true, is_visible: true },
  { id: "4", key: "riscos", name: "Monitoramento de Riscos", description: "Identifique e gerencie riscos", icon: "AlertTriangle", monthly_price: 897, annual_price: 8970, category: "governance", target_section: "monitoramento", target_section_label: "MONITORAMENTO", order_index: 4, is_active: true, is_visible: true },
  { id: "5", key: "maturidade_esg", name: "Maturidade ESG", description: "Avalie a maturidade ESG", icon: "Leaf", monthly_price: 797, annual_price: 7970, category: "strategy", target_section: "esg", target_section_label: "ESG", order_index: 5, is_active: true, is_visible: true },
  { id: "6", key: "inteligencia_mercado", name: "Inteligência de Mercado", description: "Análises de mercado em tempo real", icon: "TrendingUp", monthly_price: 997, annual_price: 9970, category: "intelligence", target_section: "inteligencia", target_section_label: "INTELIGÊNCIA", order_index: 6, is_active: true, is_visible: true },
  ...
  { id: "8", key: "agentes_ia", name: "Agentes de IA", description: "Agentes do MOAT Engine", icon: "Bot", monthly_price: 1497, annual_price: 14970, category: "strategy", target_section: "inicio", target_section_label: "INÍCIO", order_index: 8, is_active: true, is_visible: true },
