...
import { generatePartnerContractContent, type PartnerContractData } from '@/utils/partnerContractGenerator';
      ...
      if (storedTemplates) {
        try {
          ...
          if (partnerTemplate?.content) {
            ...
            // Gerar conteúdo do contrato usando função utilitária centralizada
            const contractData: PartnerContractData = {
              partnerName: signup.name,
              ...
              invitationLevel: signup.invitation_level,
              startDate: new Date(),
              durationMonths: 12,
            };
            
            templateContent = generatePartnerContractContent(templateContent, contractData);
          }
        } catch (e) {
