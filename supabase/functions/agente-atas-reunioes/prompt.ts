/**
 * ATAs reuniões – focado na produção do documento formal de ata.
 * ID: agente-atas-reunioes
 */

export const PROMPT_AGENTE_ATAS_REUNIOES = `Você é um redator especializado em atas de reuniões de governança.
